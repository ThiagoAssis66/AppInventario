  ...
  return (
    <DrawerContentScrollView {...props} contentContainerStyle={styles.drawerContent}>
      ...
      <View style={styles.drawerItems}>
        <DrawerItem
          label="Cadastramento de Unidades"
          onPress={() => props.navigation.navigate('Cadastramento de Unidades')}
          labelStyle={styles.drawerItemLabel}
        />
        <DrawerItem
          label="Relação de Unidades"
          onPress={() => props.navigation.navigate('Relação de Unidades')}
          labelStyle={styles.drawerItemLabel}
        />
      </View>
